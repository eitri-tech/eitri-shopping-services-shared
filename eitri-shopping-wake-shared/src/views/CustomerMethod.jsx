...
export default function CustomerMethod() {
  ...
  const simpleLogin = async () => {
    const result = await WakeService.customer.customerSimpleLoginStart(
      "neposod158@nozamas.com",
    );
    console.log("create >>", result);
  };
  ...
  const completeRegistration = async () => {
    ...
    const result =
      await WakeService.customer.customerCompletePartialRegistration(
        token,
        customer,
      );
    console.log("create >>", result);
  ...
  const passwordChange = async () => {
    ...
    const result = await WakeService.customer.customerPasswordChange(
      token,
      "",
      "8nBDIY6zB2",
    );
  ...
  const customerPasswordRecovery = async () => {
    const result =
      await WakeService.customer.customerPasswordRecovery("wagnerfq@gmail.com");
    console.log("result", result);
  };

  const customerPasswordChangeByRecovery = async () => {
    const result =
      await WakeService.customer.customerPasswordChangeByRecovery();
    console.log("result", result);
  };
