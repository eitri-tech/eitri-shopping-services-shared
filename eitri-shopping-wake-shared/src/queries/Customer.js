...
export const querySimpleLoginVerifyAnwser = `
mutation ($input: String!, $questionId: Uuid!, $answerId: Uuid!) {
  customerSimpleLoginVerifyAnwser(input: $input, questionId: $questionId, answerId: $answerId) {
    customerAccessToken {
      isMaster
      token
      type
